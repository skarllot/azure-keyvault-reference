...
public record KeyVaultSecretReference(Uri VaultUri, string Name, string? Version)
{
    ...
    public static bool TryParse(
        ...
        KeyVaultReferenceParser.TryParse(value, defaultVaultNameOrUri, out result);
    ...
    public static KeyVaultSecretReference Parse(string value, string? defaultVaultNameOrUri)
    {
        ...
        return KeyVaultReferenceParser.TryParse(value, defaultVaultNameOrUri, out var result)
            ? result
